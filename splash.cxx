...
Fl_Double_Window* make_window() {
  { splash_wnd = new Fl_Double_Window(480, 280);
    { header_box = new Fl_Box(0, 0, 480, 280, "QPrf");
      header_box->box(FL_FLAT_BOX);
      header_box->color(FL_SELECTION_COLOR);
      header_box->labelsize(88);
      header_box->labelcolor(FL_BACKGROUND2_COLOR);
    } // Fl_Box* header_box
    { footer_box = new Fl_Box(0, 250, 480, 25, "Copyright (C) Stanislaw Adaszewski, 2016. Visit http://algoholic.eu.");
